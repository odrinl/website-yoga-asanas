...
function handleEvent(event) {
  ...
  if (existing_tooltip_element) {
    existing_tooltip_element.parentNode.removeChild(existing_tooltip_element);
  }
  ...
  */
  ...
  if (bound_right > window_width - 5) {
    ...
    // Apply corrected position. I added 5px everyehere just to have some space between tooltip and the edge of the screen
